...
function Calculadora(){
    ...
    return (
        <div className="container">
            ...
            <form>
                <input type="text" className="number" placeholder="Número 1" onChange={(e) => setNumber1(e.target.value)} /><br />
                <input type="text" className="number" placeholder="Número 2" onChange={(e) => setNumber2(e.target.value)} /><br />
